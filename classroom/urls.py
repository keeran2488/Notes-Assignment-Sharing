...
urlpatterns = [
    ...
    path('students/', include(([
        ...
        path('assignment/<int:pk>/submit', submit_answer, name='submit_answer'),
    ...
    path('teacher/', include(([
        ...
        path('assignment/<int:pk>/result/', view_result, name='view_result'),
        path('assignment/<int:assignments_pk>/result/<int:asn_pk>/', view_answer, name='view_result_student'),
